...
for qsize in 5 20 100; do
    ...
    python plot_tcpprobe.py -f $dir/cwnd.txt -o $dir/cwnd-iperf-$qsize.png -p $iperf_port
    python plot_queue.py -f $dir/q.txt -o $dir/q-$qsize.png
    python plot_ping.py -f $dir/ping.txt -o $dir/rtt-$qsize.png
    # use the file plot_queue.py to plot the download time
    python plot_queue.py -f $dir/download.txt -o $dir/download-$qsize.png
done
